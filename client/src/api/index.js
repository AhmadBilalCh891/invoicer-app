...
export const fetchProducts = (page) => API.get(`/products/list?page=5`);
export const addProduct =( client ) => API.post('/products', client)
export const updateProduct = (id, updatedClient) => API.patch(`/products/${id}`, updatedClient)
export const deleteProduct =(id) => API.delete(`/clients/${id}`)
